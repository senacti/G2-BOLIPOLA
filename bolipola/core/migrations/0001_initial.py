# Generated by Django 4.2.4 on 2023-09-20 16:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Fiesta', verbose_name='Descripción')),
            ],
            options={
                'verbose_name': 'Evento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('goals_for', models.IntegerField(default=0, verbose_name='Goles a favor')),
                ('goals_against', models.IntegerField(default=0, verbose_name='Goles en contra')),
                ('goals_diff', models.IntegerField(default=0, verbose_name='Diferencia de goles')),
                ('games_tied', models.IntegerField(default=0, verbose_name='Partidos empatados')),
                ('games_won', models.IntegerField(default=0, verbose_name='Partidos ganados')),
                ('games_lost', models.IntegerField(default=0, verbose_name='Partidos perdidos')),
                ('games_played', models.IntegerField(default=0, verbose_name='Partidos jugados')),
        ...
        migrations.AddField(
            model_name='sale',
            name='inventory',
            field=models.ManyToManyField(to='core.inventory', verbose_name='SaleInventory'),
        ),
        migrations.AddField(
            model_name='sale',
            name='reservation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='product/', verbose_name='Imágen')),
