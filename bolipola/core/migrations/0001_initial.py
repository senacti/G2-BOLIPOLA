    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players_num', models.PositiveBigIntegerField(default=0, verbose_name='Número de jugadores')),
                ('avatar', models.ImageField(default='group.png', upload_to='', verbose_name='Avatar')),
            ],
            options={
                'verbose_name': 'Equipo',
