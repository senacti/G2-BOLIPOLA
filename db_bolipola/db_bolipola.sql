...
CREATE TABLE `comentario` (
  ...
  `user_id` bigint(20) NOT NULL,
  `score_admin` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `django_session` VALUES ('0zf21xkmj8azoxqubozio9sj829uz9ug','.eJxVjEEOwiAQRe_C2hCgwIwu3XuGZmBAqgaS0q6MdzckXej2v_f-W8y0b2Xee1rnhcVFaHH63QLFZ6oD8IPqvcnY6rYuQQ5FHrTLW-P0uh7u30GhXkYNDC5aRTkxo2ZPxmdwkDhMKlkF7KxCZ43BbOx5CuiBEBVrQIRsxecL7NA3XQ:1rAgid:K7ueaQOVVhSewWWPzVYRNLPUh69rzCsTS24SlSF547I','2023-12-19 20:28:55.844248'),('1nldo7uju2ei8xwlzkyd7yjj1uwhzqyg','e30:1r9HjV:itKJXBx4I3wtuaY6dWuOQ1TgH6OkG-CgJ_rvRnEbrhY','2023-12-15 23:36:01.477772'),('3jfrqlk5u1zttmboxwefpe844s2lh0gj','e30:1r9HwA:TjTbe9ZNnKW6Or3yMpZU3P54iqXixHJ-zcYMUEq4rD0','2023-12-15 23:49:06.204309'),('6c3cop7e2rc1gp1u2z6mm6ifvn4ikydq','.eJxVjEEOwiAQRe_C2pCxZYC4dO8ZyDADUjWQlHbVeHdt0oVu_3vvbyrQupSw9jSHSdRFGXX63SLxM9UdyIPqvWludZmnqHdFH7TrW5P0uh7u30GhXr51pjOIgJjRZ0wmDeOAhJSBs0QGFIiCZHEEF9FZQOOBJSfHPltiUu8PA3k42w:1qjmYc:Y_33CIOAGHWGvMAoNoUNrnm1egaBtimjjac2piasmGo','2023-10-06 15:15:22.621705'),('bzatgmr904c0iul3myhuq4btsie2fx2n','e30:1r9I9I:I1C6doBro6XjGyGF7QmTRNKX2O52r08kVw44YlbV1-I','2023-12-16 00:02:40.404721'),('de2plsffd5i14yvj98tim0wujo0vyhyj','e30:1r9IUX:O2byO7qOoxvbVyh42QdUQOwBHzGj8XvYIIhj67dVOIM','2023-12-16 00:24:37.857294'),('fx8wi0dnfb4ikjmis6zwwrs1janfl1kw','e30:1r9Iaa:zDI8xLX_8sl6Fsm1wIENeSBm3VMCuDZwKNUddpQd7kk','2023-12-16 00:30:52.122438'),('lq2g8ogcfdbaxl4zxzj236xpjfp6lux6','.eJxVjM0OwiAQhN-FsyFQfhY9eu8zkF1YpWogKe3J-O62SQ96mmS-b-YtIq5LiWvnOU5ZXIQTp9-OMD257iA_sN6bTK0u80RyV-RBuxxb5tf1cP8OCvayrRko6Bt4DZQxpCEwekYAdmFLPHtnkrJgFZtMMORkAlmvgmZnEIjF5wv41zhB:1rB3Nn:AHAV3dt8X4zalQ8_li00G2XbIukeMosqjLIBr8X7iDA','2023-12-20 20:40:55.474525'),('mcjumbp7jhp4hn9i8suyc1gw61xtl1uq','e30:1r9IbS:hqaaAzQ5Dl2xD6cq9G5n1JUoLs_cOgm0-rtNlLrjXnc','2023-12-16 00:31:46.449615'),('sfvp75xyt6l489howflfkb3ud39871ai','e30:1r9IVz:vJZRpRnRsTmMhwf7rcPZvcammCssJJ_2qvACRmHFFn0','2023-12-16 00:26:07.625567');
...
CREATE TABLE `user_userboli` (
  ...
  `buy_cooldown` int(10) unsigned NOT NULL CHECK (`buy_cooldown` >= 0),
  PRIMARY KEY (`id`),
